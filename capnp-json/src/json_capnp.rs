...
pub mod value {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_array(&mut self, value: ::capnp::struct_list::Reader<'_,crate::json_capnp::value::Owned>) -> ::capnp::Result<()> {
    ...
    #[inline]
    pub fn set_object(&mut self, value: ::capnp::struct_list::Reader<'_,crate::json_capnp::value::field::Owned>) -> ::capnp::Result<()> {
    ...
    #[inline]
    pub fn set_raw(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 152] = [
      ...
      ::capnp::word(216, 4, 0, 0, 47, 11, 0, 0),
    ...
    pub static MEMBERS_BY_NAME : &[u16] = &[4,1,6,0,2,5,7,3];
  ...
  pub mod field {
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 48] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(171, 10, 0, 0, 229, 10, 0, 0),
  ...
  pub mod call {
    ...
    impl <'a,> Builder<'a,>  {
      ...
      #[inline]
      pub fn set_params(&mut self, value: ::capnp::struct_list::Reader<'_,crate::json_capnp::value::Owned>) -> ::capnp::Result<()> {
        ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
      }
      #[inline]
    ...
    mod _private {
      pub static ENCODED_NODE: [::capnp::Word; 53] = [
        ...
        ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(233, 10, 0, 0, 45, 11, 0, 0),
...
pub mod flatten_options {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_prefix(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
      ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false).unwrap()
    }
    #[inline]
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 35] = [
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(180, 15, 0, 0, 35, 16, 0, 0),
...
pub mod discriminator_options {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_value_name(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 50] = [
      ...
      ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(187, 17, 0, 0, 184, 19, 0, 0),
