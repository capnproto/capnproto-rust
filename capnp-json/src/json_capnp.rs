...
pub mod value {
    pub use self::Which::{Array, Boolean, Call, Null, Number, Object, Raw, String};
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn which(self) -> ::core::result::Result<WhichReader<'a>, ::capnp::NotInSchema> {
            match self.reader.get_data_field::<u16>(0) {
                ...
                1 => ::core::result::Result::Ok(Boolean(self.reader.get_bool_field(16))),
                2 => ::core::result::Result::Ok(Number(self.reader.get_data_field::<f64>(1))),
                ...
                5 => ::core::result::Result::Ok(Object(
                    ::capnp::traits::FromPointerReader::get_from_pointer(
                        &self.reader.get_pointer_field(0),
                        ::core::option::Option::None,
                    ),
                )),
                6 => ::core::result::Result::Ok(Call(
                    ::capnp::traits::FromPointerReader::get_from_pointer(
                        &self.reader.get_pointer_field(0),
                        ::core::option::Option::None,
                    ),
                )),
                7 => ::core::result::Result::Ok(Raw(
                    ::capnp::traits::FromPointerReader::get_from_pointer(
                        &self.reader.get_pointer_field(0),
                        ::core::option::Option::None,
                    ),
    ...
    impl<'a> Builder<'a> {
        ...
        pub fn set_array(
            &mut self,
            value: ::capnp::struct_list::Reader<'_, crate::json_capnp::value::Owned>,
        ) -> ::capnp::Result<()> {
        ...
        pub fn init_array(
            self,
            size: u32,
        ) -> ::capnp::struct_list::Builder<'a, crate::json_capnp::value::Owned> {
            self.builder.set_data_field::<u16>(0, 4);
        ...
        pub fn set_object(
            &mut self,
            value: ::capnp::struct_list::Reader<'_, crate::json_capnp::value::field::Owned>,
        ) -> ::capnp::Result<()> {
        ...
        pub fn init_object(
            self,
            size: u32,
        ) -> ::capnp::struct_list::Builder<'a, crate::json_capnp::value::field::Owned> {
            self.builder.set_data_field::<u16>(0, 5);
            ::capnp::traits::FromPointerBuilder::init_pointer(
                self.builder.get_pointer_field(0),
                size,
        ...
        pub fn set_call(
            &mut self,
            value: crate::json_capnp::value::call::Reader<'_>,
        ) -> ::capnp::Result<()> {
        ...
        pub fn which(self) -> ::core::result::Result<WhichBuilder<'a>, ::capnp::NotInSchema> {
            match self.builder.get_data_field::<u16>(0) {
                0 => ::core::result::Result::Ok(Null(())),
                1 => ::core::result::Result::Ok(Boolean(self.builder.get_bool_field(16))),
                2 => ::core::result::Result::Ok(Number(self.builder.get_data_field::<f64>(1))),
                3 => ::core::result::Result::Ok(String(
    ...
    pub type WhichReader<'a> = Which<
        ...
        ::capnp::Result<::capnp::struct_list::Reader<'a, crate::json_capnp::value::Owned>>,
        ::capnp::Result<::capnp::struct_list::Reader<'a, crate::json_capnp::value::field::Owned>>,
        ::capnp::Result<crate::json_capnp::value::call::Reader<'a>>,
        ::capnp::Result<::capnp::text::Reader<'a>>,
    >;
    pub type WhichBuilder<'a> = Which<
        ::capnp::Result<::capnp::text::Builder<'a>>,
        ::capnp::Result<::capnp::struct_list::Builder<'a, crate::json_capnp::value::Owned>>,
        ::capnp::Result<::capnp::struct_list::Builder<'a, crate::json_capnp::value::field::Owned>>,
        ::capnp::Result<crate::json_capnp::value::call::Builder<'a>>,
        ::capnp::Result<::capnp::text::Builder<'a>>,
    >;
    ...
    pub mod field {
        ...
        impl<'a> Builder<'a> {
            ...
            pub fn set_value(
                &mut self,
                value: crate::json_capnp::value::Reader<'_>,
            ) -> ::capnp::Result<()> {
                ::capnp::traits::SetterInput::set_pointer_builder(
...
pub mod flatten {
    ...
    pub fn get_type() -> ::capnp::introspect::Type {
        <crate::json_capnp::flatten_options::Owned as ::capnp::introspect::Introspect>::introspect()
    }
}
...
pub mod flatten_options {
    ...
    impl<'a> Reader<'a> {
        ...
        pub fn get_prefix(self) -> ::capnp::Result<::capnp::text::Reader<'a>> {
            ::capnp::traits::FromPointerReader::get_from_pointer(
                &self.reader.get_pointer_field(0),
                ::core::option::Option::Some(&_private::DEFAULT_PREFIX[..]),
            )
        }
        #[inline]
...
pub mod discriminator {
    ...
    pub fn get_type() -> ::capnp::introspect::Type {
        <crate::json_capnp::discriminator_options::Owned as ::capnp::introspect::Introspect>::introspect()
    }
}
