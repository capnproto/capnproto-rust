...
// DO NOT EDIT.
// source: https://github.com/capnproto/capnproto/blob/348174a61642b094361fc6c98044933de3963ca2/c%2B%2B/src/capnp/rpc-twoparty.capnp
...
impl ::capnp::traits::FromU16 for Side {
  ...
  fn from_u16(value: u16) -> ::std::result::Result<Side, ::capnp::NotInSchema> {
    match value {
      0 => ::std::result::Result::Ok(Side::Server),
      1 => ::std::result::Result::Ok(Side::Client),
...
pub mod vat_id {
  ...
  impl <'a,> Reader<'a,>  {
    ...
    #[inline]
    pub fn get_side(self) -> ::std::result::Result<crate::rpc_twoparty_capnp::Side,::capnp::NotInSchema> {
